...
insert into space_access (id, create_time, update_time, create_user, update_user, version_number, authority) values (1, NOW(), NOW(), 'no context', 'no context', 1, 'ACCESS_MESSAGE_CREATE');
insert into space_access (id, create_time, update_time, create_user, update_user, version_number, authority) values (2, NOW(), NOW(), 'no context', 'no context', 1, 'ACCESS_MESSAGE_READ');

insert into application_access (id, create_time, update_time, create_user, update_user, version_number, authority) values (1, NOW(), NOW(), 'no context', 'no context', 1, 'DASHBOARD_ADMIN');
insert into application_access (id, create_time, update_time, create_user, update_user, version_number, authority) values (2, NOW(), NOW(), 'no context', 'no context', 1, 'DASHBOARD_USER');
...
insert into application_role (id, create_time, update_time, create_user, update_user, version_number, name) values (2, NOW(), NOW(), 'no context', 'no context', 1, 'BASIC_USER');

insert into application_role_application_access_join (application_role_id, application_access_id) values (1, 1);
insert into application_role_application_access_join (application_role_id, application_access_id) values (2, 2);
...
insert into user_application_role_join (user_id, application_role_id) values (2, 2);